...
PBC合宿2027（2027年4月27日（火）・身延山・246名を基準に会場レイアウトを最終調整中）の情報サイト。
...
- 会場利用の正式確約・見積・支払条件、当日詳細タイムテーブル、受付導線、持ち物が確定後、`ops-jx9rmblg/js/ops-config.js` の `todos` から該当項目を削除し、参加者ページ・運営ハブの該当箇所を更新（tbdバッジ・TODOコメントの解消）
