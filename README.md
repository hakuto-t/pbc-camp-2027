...
PBC合宿2027（2027年4月27日（火）・身延山・定員246名）の情報サイト。
...
- 2026-09-15: 参加人数の表記を講堂E案の246名に統一し、参加者ページにも定員を明記
...
- 2026-09-15: 身延山大学講堂E案・246名配置で進める方針を確定。大学側の歓迎挨拶・紹介を冒頭3〜5分設けること、参加者への会場背景の事前案内、会場確約後に5分程度で時間調整する進行を参加者ページ・運営ハブへ反映
